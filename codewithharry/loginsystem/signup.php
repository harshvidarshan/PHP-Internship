...
<html lang="en">
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST")
  {
    ...
    $result = mysqli_query($con,$usernamesql);
    ...
    if($password == $cpassword )
    {
      ...
      $insert="INSERT INTO `user`(`username`, `password`,`date`) VALUES ('$username','$passwordhash', current_timestamp())";
  ...
  <body>
    ...
    ?>
      ...
      <form action="http://localhost/training/codewithharry/loginsystem/signup.php" method="POST">
      <div class="mb-3">
